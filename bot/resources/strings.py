...
class Strings:
    ...
    room_management = ["Xonalar boshqaruvi 🏨", "Управление комнатами 🏨"]
    room_number = ["Xona raqami", "Номер комнаты"]
    room_status = ["Holati", "Статус"]
    room_free = ["Bo'sh", "Свободна"]
    room_occupied = ["Band", "Занята"]
    room_busy = ["Band", "Занята"]
    room_toggle_status = ["Holatini o'zgartirish", "Изменить статус"]
    room_status_updated = ["Xona holati o'zgartirildi", "Статус комнаты изменен"]
    room_free_text = ["Bo'sh", "СВОБОДНА"]
    room_busy_text = ["Band", "ЗАНЯТА"]
    room_tap_to_change = ["Bosib o'zgartirish", "Нажмите чтобы изменить"]
    room_status_updated_success = ["Holat muvaffaqiyatli o'zgartirildi!", "Статус успешно изменен!"]
    room_update_error = ["Holatni o'zgartirishda xatolik yuz berdi", "Ошибка при изменении статуса"]
